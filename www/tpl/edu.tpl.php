...
<a href = "javascript:void(0)" onclick = "$('light').style.display='block';$('fade').style.display='block'">
	<img title="<?=T('adm_filter');?>" src="<?=PUB;?>img/filter.png"></a>	
			...
			<table class="wrp" cellspacing="0">
				<?php if(!$_filter){ ?>
					 <tr>
						 <td colspan=3>
							<h4><b>
							<?php  if($data['confirmed'] < 2 ) {
								echo $data['name'].", ".T('let`s get your profile started');
							} else { ?>
								<a href="javascript:void(0)"><?=T('Change education data');?></a>
							<? } ?>					
							</b></h4>					
						 </td>
					 </tr>
