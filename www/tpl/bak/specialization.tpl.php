...
<?php switch($do){ 
	...
	<tr>
		<thead>
			...
			<td width="480"><b><font color="3e3e3e"><?=T('adm_spec');?></font></b></td>
	...
	// Add\Edit  item
	case 'item' : ?>
		<form id="specform" method="POST" action="<?=$pre.$class?>/save">
		<input type="hidden" name="id" id="id" value="<?=$id;?>">
			...
			<?php unset($data[0]); //inspect($data);  inspect($fields);?>
				...
				<tr>
					<td></td>
					<td align="left">
						<a onclick="$('specform').submit()" href="javascript:void(0)">
